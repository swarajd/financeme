  ...
  switch (x) {
    case 1:
      ...
      outputText = "You can rock overtime. Sadder time but more rock. Is it worth? " +
        "(Get " + bonusRock + " rocks AND lose " + -1 * bonusJoy + " joy.)";
      break;
    case 2:
      bonusRock = Math.floor((Math.random() * 100) + 100);
      bonusJoy = Math.floor((Math.random() * 10) + 10);
      outputText = "Time for vacation. You need time off. Go to rock and roll concert? " +
        "(Get " + bonusJoy + " joy AND lose " + -1 * bonusRock + " rocks.)";
      break;
    case 3:
      bonusRock = Math.floor((Math.random() * 100) + 100);
      bonusJoy = Math.floor((Math.random() * 10) + 10);
...
function decisions() {
  ...
  switch (x) {
    ...
    case 2:
      ...
      decisionText.push("Lose " + -1 * bonusJoy + " joy.");
      decisionText.push("Lose " + -1 * bonusRock + " rocks.");
      break;
    case 3:
      bonusRock = Math.floor((Math.random() * 100) + 100);
      bonusJoy = Math.floor((Math.random() * 10) + 10);
  ...
  switch (x) {
    ...
    case 2:
      ...
      outputText = "\"You lack skill. You deserve less rocks.\" - Boss. " +
        "Get Demotion! " +
        "Now recieve " + -1 * promotionRock + " less rocks every two months.";
      break;
    default:
      outputText = "You rocked out of control!";
      bonusRock = -1;
